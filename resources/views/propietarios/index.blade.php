...
@endsection
@section('contenido')
 <a href="{{route ('propietarios.pdf')}} " type="button" class="btn btn-danger" ><i class="fas fa-file-pdf"></i> Exportar a pdf</a>
         ...
         <div class="container ">
            <h4 class="titulo center" ><b>LISTADO DE PROPIETARIOS</b> </h4>
        ...
        <a href="{{url('propietarios/create')}} " type="button" class="btn btn-success" >Agregar Propietario</a>
...
<script type="text/javascript">
   $(document).ready(function() {
        $('#miTabla').DataTable({
            ...
            "ajax": "{!!URL::to('propietarios')!!}",
                "columns":[
                    
                    {data:'Id_propietario'},
                    {data:'Nom_propietario'},
                    {data:'Ciudad'},
                    {data:'Dir_propietario'},
                    {data:'Tel_propietario'},
                    {data:'Cor_propietario'},
                    {data: 'action'},
                    
                   
                ],
                'fnCreatedRow':function(nRow,aData,iDataIndex){
                        $(nRow).attr('class','item'+aData.Id_propietario);
                    },
          "language":{
...
$(document).on('click','.btneliminar', function($Id_propietario){
    $.ajaxSetup({
  headers: {
